...
const aggregatorSubtotal6 = subtotal6(rows6);
const aggregatorTaxes6 = TAX_RATE * aggregatorSubtotal6;
const aggregatorTotal6 = aggregatorTaxes6 + aggregatorSubtotal6;
              ...
              <Table className={classes6.table}>
                ...
                <TableBody>
                  ...
                  <TableRow>
                    ...
                    <TableCell align="right">
                      {ccyFormat6(aggregatorSubtotal6)}
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    ...
                    <TableCell align="right">
                      {ccyFormat6(aggregatorTaxes6)}
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell colSpan={2}>Total</TableCell>
                    <TableCell align="right">
                      {ccyFormat6(aggregatorTotal6)}
                    </TableCell>
                  </TableRow>
                </TableBody>
              </Table>
...
const aggregatorSubtotal = subtotal(rows);
const aggregatorTaxes = TAX_RATE * aggregatorSubtotal;
const aggregatorTotal = aggregatorTaxes + aggregatorSubtotal;
      ...
      <Table className={classes.table}>
        ...
        <TableBody>
          ...
          <TableRow>
            <TableCell rowSpan={3} />
            <TableCell colSpan={2}>Subtotal</TableCell>
            <TableCell align="right">{ccyFormat(aggregatorSubtotal)}</TableCell>
          </TableRow>
          <TableRow>
            <TableCell>Tax</TableCell>
            <TableCell align="right">{\`\${(TAX_RATE * 100).toFixed(0)} %\`}</TableCell>
            <TableCell align="right">{ccyFormat(aggregatorTaxes)}</TableCell>
          </TableRow>
          <TableRow>
            <TableCell colSpan={2}>Total</TableCell>
            <TableCell align="right">{ccyFormat(aggregatorTotal)}</TableCell>
          </TableRow>
        </TableBody>
      </Table>
    </Paper>
